...
export const GUIDE = {
  ...
  fit: {
    intro: "Three places to look, in order.",
    title: "Fit · payments / fintech backend",
    items: [
      {
        id: "bibo",
        text: "multi-step on-chain transactions persisted before signing and advanced only by on-chain receipts; indexed data renders the market, live chain reads authorize the trade.",
      },
      {
        id: "amm",
    ...
    note: "Scope note: BIBO is team-built (Pulin delivered the frontend and backend); the other systems are solo builds. Day job: a year of production backend work in a team, TypeScript / Node.",
  },
...
/** Nudge after a question the script does not know: the five project names. */
