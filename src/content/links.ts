...
export const MAILTO =
  `mailto:${EMAIL}?subject=${encodeURIComponent('Hi Pulin — [role] at [company]')}` +
  `&body=${encodeURIComponent('Hi Pulin,\n\nI saw your work on ... and would like to talk about ...\n\n')}`;
...
// The blog is not built yet: a placeholder with no address, rendered as a "coming soon" chip.
export const BLOG = { href: null, mock: true } as const;
