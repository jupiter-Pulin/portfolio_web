...
const ART: Record<string, ReactElement> = {
  bibo: (
    <svg viewBox="0 0 400 300" fill="none" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M62 140H338" stroke="var(--line-strong)" strokeWidth="2"/>
      <g strokeWidth="2.5">
        <circle cx="80" cy="140" r="17" fill="var(--surface-2)" stroke="var(--cyan)"/>
        <circle cx="160" cy="140" r="17" fill="var(--surface-2)" stroke="var(--cyan)"/>
        <circle cx="240" cy="140" r="17" fill="rgba(52,211,153,.18)" stroke="var(--green)"/>
        <circle cx="320" cy="140" r="17" fill="var(--surface-2)" stroke="var(--dim)" strokeDasharray="4 4"/>
      </g>
      <path d="M232 140l6 6 12-12" stroke="var(--green)" strokeWidth="3"/>
      <path d="M80 123v-30h80M160 123v-30" stroke="var(--dim)" strokeWidth="1.5" strokeDasharray="3 4"/>
      <text x="120" y="82" fontFamily="var(--font-mono)" fontSize="11" fill="var(--dim)" textAnchor="middle">persisted before signing</text>
      <g fontFamily="var(--font-mono)" fontSize="11.5" fill="var(--muted)" textAnchor="middle">
        <text x="80" y="182">stage 1</text><text x="160" y="182">stage 2</text><text x="240" y="182">receipt</text><text x="320" y="182">stage 4</text>
      </g>
      <rect x="62" y="214" width="276" height="34" rx="9" stroke="var(--line-strong)" strokeWidth="1.5"/>
      <text x="200" y="236" fontFamily="var(--font-mono)" fontSize="11.5" fill="var(--muted)" textAnchor="middle">only an on-chain receipt advances a stage</text>
    </svg>
  ),
  loop: (
    <svg viewBox="0 0 400 300" fill="none" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
